   ...
   <footer class="footer row row-cols-8 pt-5 border-top">
     <div class="col-sm-4 col-md-8 order-md-0 order-lg-0 col-lg-4">
       ...
       <ul class="list-unstyled d-flex justify-content-center">
         <a href="https://www.youtube.com/c/RVRJCCollegeofEngineering" target="_blank"><img class="m-1" style="width:40px;height:40px" src="./icons/youtube-svg.svg" alt="YouTube"></a>
         <a href="https://www.facebook.com/RVR-JC-College-of-Engineering-Autonomous-442983819071705" target="_blank"><img class=" m-1" style="width:40px;height:40px" src="./icons/facebook-svg.svg" alt="facebook"></a>
         <a href="https://twitter.com/rvrjc_official" target="_blank"><img class="rounded-circle m-1" style="width:40px;height:40px" src="./icons/x-svg.svg" alt="twitter"></a>
         <a href="https://www.instagram.com/rvrjcce.official/" target="_blank"><img class="m-1" style="width:40px;height:40px" src="./icons/instagram-svg.svg" alt="instagram"></a>
         <a href="https://www.linkedin.com/school/r.v.r.-&-j.c.-college-of-engineering/" target="_blank"><img class="m-1" style="width:40px;height:40px" src="./icons/linkedin-svg.svg" alt="Linkedin"></i></a>
       </ul>
     </div>
