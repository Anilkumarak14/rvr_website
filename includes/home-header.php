<!-- search section -->
  ...
  <div class="home-center-nav">
    <div class="intro-nav3">
      <a href="#placements" class="intro-nav3-link">Placements</a>
      <a href="#randcell" class="intro-nav3-link">R&D Cell</a>
      <a href="#alumini" class="intro-nav3-link">ALUMNI</a>
      <a href="#iqac" class="intro-nav3-link">IQAC</a>
      <a href="#notice" class="intro-nav3-link">NOTICES</a>
    </div>
  </div>
<!-- Home Main Container -->
<script>
