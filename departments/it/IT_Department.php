...
<body>
  ...
  <div id="main-content">
    <div class="info">
      ...
      <div style="border: solid #660000;box-shadow: 0 6px 20px -8px black; margin:10px 15px">
        <div style="margin: 10px 0px ;">
          <!-- navbar -->
          <div class="home-nav-box intro-nav2 d-flex align-items-center list-unstyled ">
              <li class="dropdown dropdown-container">
                <a href="./admissions.php" class="intro-nav2-link home-nav-option fw-bold" style="letter-spacing: 0.13rem;  color:black; font-size:12px" >Admissions</a>
              ...
              <li class="dropdown dropdown-container">
                <a class="intro-nav2-link home-nav-option fw-bold" style="letter-spacing: 0.13rem; color:black; font-size:12px"  href="" data-bs-toggle="dropdown">Campus Life</a>
                  <ul class="dropdown-menu">
              ...
              <li class="dropdown dropdown-container">
                <a class="intro-nav2-link home-nav-option fw-bold" style="letter-spacing: 0.13rem; color:black; font-size:12px"  href="departments.html" data-bs-toggle="dropdown">Departments</a>
                  <ul class="dropdown-menu">
              ...
              <li class="dropdown dropdown-container">
                <a class="intro-nav2-link home-nav-option fw-bold" style="letter-spacing: 0.13rem; color:black; font-size:12px"  href="">People</a>
                  <ul class="dropdown-menu">
              ...
              <li class="dropdown dropdown-container">
                <a class="intro-nav2-link home-nav-option fw-bold " style="letter-spacing: 0.13rem; color:black; font-size:12px" href="">Committees</a>
                  <ul class="dropdown-menu">
        ...
        <div class="d-flex justify-content-between p-3">
          ...
          <div style="padding-right: 40px;" >
            <img width="340px" src="./images/chemical.png" alt="deparments-img">
          </div>
        </div>
      </div>
  ...
  <div class="note d-flex justify-content-evenly flex-wrap">
    <div class="about-box shadow-lg">
        ...
        <div class="para">Established by the renowned Nagarjuna Education Society (1967) in 
            ...
            <img class="curve" src="images/principal.svg" alt="">
    </div>
    <div class="about-box shadow-lg">
